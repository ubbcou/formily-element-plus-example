...
export const createFormGrid = (props: IFormGridProps): Grid<HTMLElement> => markRaw(new Grid(props))
 ...
 * @deprecated
 */
const useGridSpan = (gridSpan: number) => gridSpan

/**
 * @deprecated
 */
export const useGridColumn = (gridSpan = 'span 1') => gridSpan
